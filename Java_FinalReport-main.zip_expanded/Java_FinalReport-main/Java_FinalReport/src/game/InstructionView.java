...
public class InstructionView {
    ...
    public static void showInstructions() {
        ...
        System.out.println("此次賭局遊戲為「雙重印地安撲克」，四名參賽者一組──");
        System.out.println(GameUtils.RED +"這是一場圍繞權力階級、忠誠與背叛、出千與偽裝的心理博弈，" + GameUtils.RESET);
        System.out.println( GameUtils.RED +"你必須靠智慧與膽識，擊敗對手，奪回自由。" + GameUtils.RESET) ;
        ...
        System.out.println("====================================");
        System.out.println("♣");
        System.out.println(GameUtils.RED+"\n※ 選擇出千將冒更高風險，但可能獲得關鍵優勢。"  + GameUtils.RESET);
        System.out.println(GameUtils.RED+ "※ 若輸掉所有籌碼，將成為完全的敗犬。"  + GameUtils.RESET);
        System.out.println("===============================\n" );
        System.out.println("♥");
    }
}
